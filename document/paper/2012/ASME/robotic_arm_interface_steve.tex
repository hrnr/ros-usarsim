...
\begin{figure}[t!]
\centering
\subfigure[Location of joint axes in USARSim model of KR60,]{\label{Fig:KR60Anotated}\includegraphics[width=4cm]{Figures/Robots/KR60Profile.jpg}}\qquad
\subfigure[Depiction of joint axes from TF topic in ROS.]{\label{Fig:KR60TF}\includegraphics[width=4cm]{Figures/ROS/rviz1.png}}
